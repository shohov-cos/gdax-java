...
public interface CoinbaseWallet extends CoinbaseCommon {
    ...
    <T> CompletableFuture<Page<T>> pagedGetAsync(String endpoint, TypeReference<Page<T>> typeReference, String startingAfter, String endingBefore, Integer limit, String order);
}
